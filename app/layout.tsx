...
export const metadata: Metadata = {
  title: 'LTR - Cafetería | TRL cafeteria',
  description: 'LTR - Cafetería (TRL cafeteria): Una cafetería con alma peruana en Lima. Descubre los auténticos sabores de la costa, sierra y selva del Perú en cada taza y plato.',
  keywords: [
    'cafetería', 'café', 'Lima', 'Perú', 'desayunos', 'postres', 'costa', 'sierra', 'selva', 'Las Tres Regiones', 'LTR', 'TRL cafeteria', 'trl cafeteria', 'carta', 'galería', 'servicios', 'ambiente', 'barista', 'pastelería', 'panadería', 'restaurante', 'especialidades', 'artesanal'
  ],
